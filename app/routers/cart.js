...
import { validateAddToCart, authorizePermission } from '../middlewares/validators.js'
...
router.post('/cart', authorizePermission(Permission.ADD_CART), validateAddToCart, async (req, res) => {
...
router.delete('/cart', authorizePermission(Permission.DELETE_CART), async (req, res) => {
